...
function emitToRenderer(win: Electron.BrowserWindow, event: TransportBridgeEvent): void {
...
function flushBatch(conn: ManagedSerialPort, win: Electron.BrowserWindow): void {
...
function scheduleBatchFlush(conn: ManagedSerialPort, win: Electron.BrowserWindow): void {
...
function wirePortEvents(conn: ManagedSerialPort, win: Electron.BrowserWindow): void {
...
export function registerSerialHandlers(mainWindow: Electron.BrowserWindow): void {
