...
function flushBatch(batchable: Batchable, connectionId: string, win: Electron.BrowserWindow): void {
...
function scheduleBatchFlush(batchable: Batchable, connectionId: string, win: Electron.BrowserWindow): void {
...
export function registerNetworkHandlers(mainWindow: Electron.BrowserWindow): void {
