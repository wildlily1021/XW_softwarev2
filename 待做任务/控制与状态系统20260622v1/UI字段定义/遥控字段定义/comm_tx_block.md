...
| 参数原始字段名 | UI显示名称 | word | 索引位宽 | 有符号/无符号 | UI类型 | 参数表格索引 |
| --- | --- | --- | --- | --- | --- | --- |
| `COMM_TX_PARAM_BER_INJECT_C` | 误码注入模式 | `0` | `word[3:0]` | 无符号数 | 下拉栏 | [UI_COMM_TX_CMD_GROUP_FAULT_C_COMM_TX_PARAM_BER_INJECT_C](#ui_comm_tx_cmd_group_fault_c_comm_tx_param_ber_inject_c) |
...
| `COMM_TX_PARAM_DATA_LINK_BREAK_C` | 数据断链异常注入控制 | `6` | `word[0]` | 无符号数 | 使能开关 | [UI_COMM_TX_CMD_GROUP_FAULT_C_COMM_TX_PARAM_DATA_LINK_BREAK_C](#ui_comm_tx_cmd_group_fault_c_comm_tx_param_data_link_break_c) |
...
| `COMM_TX_PARAM_ENDIAN_ERROR_C` | 字节序故障注入控制 | `9` | `word[3:0]` | 无符号数 | 下拉栏 | [UI_COMM_TX_CMD_GROUP_FAULT_C_COMM_TX_PARAM_ENDIAN_ERROR_C](#ui_comm_tx_cmd_group_fault_c_comm_tx_param_endian_error_c) |
