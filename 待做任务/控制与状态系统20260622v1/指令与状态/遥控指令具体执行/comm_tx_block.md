...
| group参数个数 | `10` |
| payload数据字数 | `10` |
| payload_length_bytes | `0000002C` |
| 应用层头字 | `117110A0` |
| 校验字 | `2C410CE9` |
| 完整字节流 | `1A CF FC 1D 00 00 00 2C 11 71 10 A0 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 2C 41 0C E9` |
...
| 2 | 应用层头 | `117110A0` |
| 3..12 | 参数数据字 0..9 | 默认均为 `00000000` |
| 13 | checksum | `2C410CE9` |

帧类异常使用 `COMM_TX_PARAM_FRAME_FAULT_SCOPE_C` 控制作用范围。大小端异常、帧头位置异常、链路通断异常不依赖该帧控制使能。
