...
| `comm_tx_block` | [comm_tx_block.md](comm_tx_block.md) | `TM_GROUP_RUNTIME_C`<br>`TM_GROUP_CFG_C`<br>`COMM_TX_TM_GROUP_FAULT_RUNTIME_C`<br>`COMM_TX_TM_GROUP_FAULT_CFG_C` |
