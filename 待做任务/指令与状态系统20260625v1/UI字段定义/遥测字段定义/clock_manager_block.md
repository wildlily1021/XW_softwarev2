...
| --- | --- | --- | --- | --- | --- | --- |
| `clock_lock_status[2]` | lmk100M锁定 | `0` | `word[0]` | 无符号数 | 显示 | [UI_TM_GROUP_RUNTIME_C_CLOCK_LOCK_STATUS_2](#ui_tm_group_runtime_c_clock_lock_status_2) |
| `clock_lock_status[1]` | adc数据时钟锁定 | `1` | `word[0]` | 无符号数 | 显示 | [UI_TM_GROUP_RUNTIME_C_CLOCK_LOCK_STATUS_1](#ui_tm_group_runtime_c_clock_lock_status_1) |
| `clock_lock_status[0]` | adc核时钟锁定 | `2` | `word[0]` | 无符号数 | 显示 | [UI_TM_GROUP_RUNTIME_C_CLOCK_LOCK_STATUS_0](#ui_tm_group_runtime_c_clock_lock_status_0) |
