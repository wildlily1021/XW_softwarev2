...
| [TM_GROUP_RUNTIME_C_WORD_5](#tm_group_runtime_c_word_5) | `board_status[4]` | LMX1 | `bool_to_u32(stat_i.board_status[4])` | `1 bit` |
| [TM_GROUP_RUNTIME_C_WORD_6](#tm_group_runtime_c_word_6) | `board_status[3]` | LMK12 | `bool_to_u32(stat_i.board_status[3])` | `1 bit` |
| [TM_GROUP_RUNTIME_C_WORD_7](#tm_group_runtime_c_word_7) | `board_status[2]` | SPI完成 | `bool_to_u32(stat_i.board_status[2])` | `1 bit` |
| [TM_GROUP_RUNTIME_C_WORD_8](#tm_group_runtime_c_word_8) | `board_status[1]` | 采样有效 | `bool_to_u32(stat_i.board_status[1])` | `1 bit` |
| [TM_GROUP_RUNTIME_C_WORD_9](#tm_group_runtime_c_word_9) | `board_status[0]` | ADC上电 | `bool_to_u32(stat_i.board_status[0])` | `1 bit` |
| [TM_GROUP_RUNTIME_C_WORD_10](#tm_group_runtime_c_word_10) | `rx_power_value` | 接收功率测量值 | `stat_i.rx_power_value` | `32 bit` |
...
| group_id | `8'h80` |
| 上报字索引 | `5` |
| 来源表达式 | `bool_to_u32(stat_i.board_status[4])` |
| 关联字段 | `board_status[4]` |
| 字段中文名 | LMX1 |
| 字段真实位宽 | `1 bit` |
| 应用层上报字位宽 | `32 bit` |
...
| group_id | `8'h80` |
| 上报字索引 | `6` |
| 来源表达式 | `bool_to_u32(stat_i.board_status[3])` |
| 关联字段 | `board_status[3]` |
| 字段中文名 | LMK12 |
| 字段真实位宽 | `1 bit` |
| 应用层上报字位宽 | `32 bit` |
...
| group_id | `8'h80` |
| 上报字索引 | `7` |
| 来源表达式 | `bool_to_u32(stat_i.board_status[2])` |
| 关联字段 | `board_status[2]` |
| 字段中文名 | SPI完成 |
| 字段真实位宽 | `1 bit` |
| 应用层上报字位宽 | `32 bit` |
...
| group_id | `8'h80` |
| 上报字索引 | `8` |
| 来源表达式 | `bool_to_u32(stat_i.board_status[1])` |
| 关联字段 | `board_status[1]` |
| 字段中文名 | 采样有效 |
| 字段真实位宽 | `1 bit` |
| 应用层上报字位宽 | `32 bit` |
...
| group_id | `8'h80` |
| 上报字索引 | `9` |
| 来源表达式 | `bool_to_u32(stat_i.board_status[0])` |
| 关联字段 | `board_status[0]` |
| 字段中文名 | ADC上电 |
| 字段真实位宽 | `1 bit` |
| 应用层上报字位宽 | `32 bit` |
