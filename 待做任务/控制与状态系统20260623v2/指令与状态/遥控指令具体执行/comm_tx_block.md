...
| 应用层头字 | `117110B0` |
| 校验字 | `2C410CFD` |
| 完整字节流 | `1A CF FC 1D 00 00 00 30 11 71 10 B0 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 2C 41 0C FD` |
...
| 2 | 应用层头 | `117110B0` |
| 3..13 | 参数数据字 0..10 | 默认均为 `00000000` |
| 14 | checksum | `2C410CFD` |
