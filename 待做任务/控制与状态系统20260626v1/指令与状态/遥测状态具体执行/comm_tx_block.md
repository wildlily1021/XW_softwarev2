...
| group_id | `8'h90` |
| 上报字数 | `14` |
| payload_length_bytes | `0000003C` |
| 应用层头字 | `127900E0` |
| 校验字 | `2D48FD39` |
| 完整字节流 | `1A CF FC 1D 00 00 00 3C 12 79 00 E0 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 2D 48 FD 39` |

| 上报字索引 | 来源表达式 | 关联字段 | 默认值 |
| --- | --- | --- | --- |
| `0` | `{28'h0000_000, stat_i.ber_inject_mode_status}` | `ber_inject_mode_status` | `00000000` |
| `1` | `{28'h0000_000, stat_i.crc_error_inject_status}` | `crc_error_inject_status` | `00000000` |
| `2` | `{28'h0000_000, stat_i.header_error_inject_status}` | `header_error_inject_status` | `00000000` |
| `3` | `{28'h0000_000, stat_i.data_type_error_inject_status}` | `data_type_error_inject_status` | `00000000` |
| `4` | `{28'h0000_000, stat_i.field_pos_error_inject_status}` | `field_pos_error_inject_status` | `00000000` |
| `5` | `{28'h0000_000, stat_i.encode_error_inject_status}` | `encode_error_inject_status` | `00000000` |
| `6` | `bool_to_u32(stat_i.data_link_break_status)` | `data_link_break_status` | `00000000` |
| `7` | `{28'h0000_000, stat_i.frame_fault_scope_status}` | `frame_fault_scope_status` | `00000000` |
| `8` | `{28'h0000_000, stat_i.frame_count_error_inject_status}` | `frame_count_error_inject_status` | `00000000` |
| `9` | `{28'h0000_000, stat_i.endian_error_inject_status}` | `endian_error_inject_status` | `00000000` |
| `10` | `bool_to_u32(stat_i.optical_signal_interrupt_status)` | `optical_signal_interrupt_status` | `00000000` |
| `11` | `{28'h0000_000, stat_i.frame_content_repeat_status}` | `frame_content_repeat_status` | `00000000` |
| `12` | `{28'h0000_000, stat_i.encode_sel_status}` | `encode_sel_status` | `00000000` |
| `13` | `{28'h0000_000, stat_i.actual_encode_sel_status}` | `actual_encode_sel_status` | `00000000` |
...
| 应用层头字 | `127910C0` |
| 校验字 | `2D490D11` |
| 完整字节流 | `1A CF FC 1D 00 00 00 34 12 79 10 C0 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 2D 49 0D 11` |
...
| `11` | `{28'h0000_000, cfg_i.frame_content_repeat_inject}` | `frame_content_repeat_inject` | `00000000` |
