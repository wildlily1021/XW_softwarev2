...
| --- | --- | --- | --- | --- |
| [TM_GROUP_RUNTIME_C_WORD_0](#tm_group_runtime_c_word_0) | `total_count` | 业务发送总帧计数 | `stat_i.total_count` | `32 bit` |
| [TM_GROUP_RUNTIME_C_WORD_1](#tm_group_runtime_c_word_1) | `link_status_frame_count` | 链路状态帧计数 | `stat_i.link_status_frame_count` | `32 bit` |
| [TM_GROUP_RUNTIME_C_WORD_2](#tm_group_runtime_c_word_2) | `flow_ctrl_frame_count` | 流控帧计数 | `stat_i.flow_ctrl_frame_count` | `32 bit` |
| [TM_GROUP_RUNTIME_C_WORD_3](#tm_group_runtime_c_word_3) | `reset_status` | 业务发送复位状态 | `bool_to_u32(stat_i.reset_status)` | `1 bit` |
