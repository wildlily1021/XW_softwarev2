...
| `COMM_TX_TM_GROUP_FAULT_RUNTIME_C` | `8'h90` | `TM_FAULT_RUNTIME_WORDS_C` | 14 | 异常注入运行状态回显 |
| `COMM_TX_TM_GROUP_FAULT_CFG_C` | `8'h91` | `TM_FAULT_CFG_WORDS_C` | 12 | 异常注入配置回显 |
...
| `1` | 当前 CRC 故障注入状态 | `crc_error_inject_status` | `{28'h0000_000, stat_i.crc_error_inject_status}` | `4 bit` |
| `2` | 当前帧头故障注入状态 | `header_error_inject_status` | `{28'h0000_000, stat_i.header_error_inject_status}` | `4 bit` |
| `3` | 当前数据类型故障注入状态 | `data_type_error_inject_status` | `{28'h0000_000, stat_i.data_type_error_inject_status}` | `4 bit` |
| `4` | 当前字段位置故障注入状态 | `field_pos_error_inject_status` | `{28'h0000_000, stat_i.field_pos_error_inject_status}` | `4 bit` |
| `5` | 当前编码故障注入状态 | `encode_error_inject_status` | `{28'h0000_000, stat_i.encode_error_inject_status}` | `4 bit` |
| `6` | 当前星间通信数据帧停发状态 | `data_link_break_status` | `bool_to_u32(stat_i.data_link_break_status)` | `1 bit` |
| `7` | 当前帧类故障生效范围状态 | `frame_fault_scope_status` | `{28'h0000_000, stat_i.frame_fault_scope_status}` | `4 bit` |
| `8` | 当前帧计数故障注入状态 | `frame_count_error_inject_status` | `{28'h0000_000, stat_i.frame_count_error_inject_status}` | `4 bit` |
| `9` | 当前字节序故障注入状态 | `endian_error_inject_status` | `{28'h0000_000, stat_i.endian_error_inject_status}` | `4 bit` |
| `10` | 星间光信号中断状态 | `optical_signal_interrupt_status` | `bool_to_u32(stat_i.optical_signal_interrupt_status)` | `1 bit` |
| `11` | 帧内容重复状态 | `frame_content_repeat_status` | `{28'h0000_000, stat_i.frame_content_repeat_status}` | `4 bit` |
| `12` | 配置编码类型状态 | `encode_sel_status` | `{28'h0000_000, stat_i.encode_sel_status}` | `4 bit` |
| `13` | 实际编码类型状态 | `actual_encode_sel_status` | `{28'h0000_000, stat_i.actual_encode_sel_status}` | `4 bit` |
...
| `11` | 帧内容重复状态镜像 | `frame_content_repeat_inject` | `{28'h0000_000, cfg_i.frame_content_repeat_inject}` | `4 bit` |
