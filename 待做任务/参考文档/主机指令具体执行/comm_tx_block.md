...
| 应用层头字 | `11710090` |
| 校验字 | `2C40FCD5` |
| 完整字节流 | `1A CF FC 1D 00 00 00 28 11 71 00 90 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 2C 40 FC D5` |
...
| --- | --- | --- |
| 0 | RS422 帧头 | `1ACFFC1D` |
| 1 | payload_length_bytes | `00000028` |
| 2 | 应用层头 | `11710090` |
| 3 | 参数数据字 0 | `00000000` |
| 4 | 参数数据字 1 | `00000000` |
| 5 | 参数数据字 2 | `00000000` |
