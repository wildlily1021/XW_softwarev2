...
| 应用层头字 | `12180060` |
| 校验字 | `2CE7FC99` |
| 完整字节流 | `1A CF FC 1D 00 00 00 1C 12 18 00 60 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 2C E7 FC 99` |
...
| `5` | `stat_i.rx_power_value` | `rx_power_value` | `32 bit` | `00000000` |
