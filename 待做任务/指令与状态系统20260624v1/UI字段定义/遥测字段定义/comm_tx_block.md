...
| `optical_signal_interrupt_status` | 当前星间光信号中断状态 | `4` | `word[0]` | 无符号数 | 显示 | [UI_COMM_TX_TM_GROUP_FAULT_RUNTIME_C_OPTICAL_SIGNAL_INTERRUPT_STATUS](#ui_comm_tx_tm_group_fault_runtime_c_optical_signal_interrupt_status) |
