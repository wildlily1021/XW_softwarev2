...
| 应用层头字 | `12880150` |
| 校验字 | `2D57FDC5` |
| 完整字节流 | `1A CF FC 1D 00 00 00 58 12 88 01 50 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 2D 57 FD C5` |
...
`rate_sel` 回读显示：`8'h00/01/02/03/04` 分别为 PSK 312M/625M/1.25G/2.5G/5G；`8'h80` 为 OOK 20M，`8'hA0` 为 OOK 10M，`8'hC0` 为 OOK 1M。接收端 OOK 目前只做配置与回读占位，未接入 OOK 解调。
